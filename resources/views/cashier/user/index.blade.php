...
<div class="container">
                    <div class="row margint90">
                        <ul class="breadcrumb">
                            <li><a href="#">Home</a></li>
                            <li><a href="{{url('cashier/user/')}}">User</a></li>
                            ...
                            <div>
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li @if (!@$filter) class="active" @endif>
                                        <a href="{{url('cashier/user')}}"><span class="fa fa-list"></span> List</a>           
                                    </li>
                                    <li @if (@$filter == 'pelanggan') class="active" @endif>
                                        <a href="{{url('cashier/user/filter/pelanggan')}}"><span class="fa fa-user"></span> Pelanggan</a>            
                                    </li> 
                                    <li @if (@$filter == 'pegawai') class="active" @endif>
                                        <a href="{{url('cashier/user/filter/pegawai')}}"><span class="fa fa-black-tie"></span> Pegawai</a>           
                                    </li>
                                    <li @if (@$filter == 'pemilik') class="active" @endif>
                                        <a href="{{url('cashier/user/filter/pemilik')}}"><span class="fa fa-black-tie"></span> Pemilik</a>           
                                    </li>
                                </ul>
                        ...
                        <div class="col-md-4 col-sm-8 padt10 col-xs-12">
                            ...
                            <div class="panel panel-medidu">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="box">
                                            <a href="{{ url('cashier/user/')}}/{{$filter}}/add" class="btn btn-success btn-block"><i class="fa fa-plus-circle"></i> Tambah Data</a>
                                        </div>
                                    </div>
                                    @endif
...
<script id="details-layouts" type="text/x-handlebars-layouts">
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <a href="{{url('cashier/user')}}/@{{filter}}/@{{id}}/edit" user-id="@{{id}}" name="@{{name}}" class="btn btn-block btn-primary edit"><i class="glyphicon glyphicon-pencil"></i> Edit</a>
            </td>
        </tr>
    </table>
</script>
...
$(document).ready(function(){
    ...
    var table = $('#user-table').DataTable({
        ...
        serverSide: true,
        @if (@$filter)
        ajax: "{{ url('cashier/user/datatables/filter') }}/{{$filter}}",
        @else
        ajax: "{{ url('cashier/user/datatables') }}",
        @endif
        columns: [
            {
