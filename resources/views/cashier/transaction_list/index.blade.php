                        ...
                        <div class="col-xs-12 col-sm-8 col-md-8 padt10 panel-medidu">
                            ...
                            <div>
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="active">
                                        <a href="{{url('cashier/transaction')}}"><span class="fa fa-list"></span> Terbaru</a>           
                                    </li>
                        ...
                        <div class="col-md-4 col-sm-8 padt10 col-xs-12">
                            ...
                            <div class="panel panel-medidu">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="box">
                                            <a href="{{ url('cashier/transaction')}}/{{@$filter}}/add" class="btn btn-success btn-block"><i class="fa fa-plus-circle"></i> Tambah Data</a>
                                        </div>
                                    </div>
                                    @endif
...
<script id="details-layouts" type="text/x-handlebars-layouts">
    <form action="{{url('cashier/transaction/list')}}/@{{id}}/update" method="post">
    {{csrf_field()}}
    <table class="table">
        <tr>
...
$(document).ready(function(){
    ...
    var table = $('#transaction-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url('cashier/transaction/list/datatables')}}",
        columns: [
    ...
    $('#submit_form').on('submit', function(event){
        ...
        $.ajax({
                url:"{{url('cashier/transaction/update')}}",
                mehtod:"post",
                data:{id:id},
                data:form_data,
                dataType:'json',
