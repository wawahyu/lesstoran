    ...
    <tr>
        <td class="border-top border-bottom">
            <table width="100%" cellspacing="3">
                @foreach (\App\Detail_Order::where('id_order', $id)->leftJoin('masakans', 'detail_orders.id_masakan', 'masakans.id')->get(['detail_orders.qty as qty', 'masakans.nama as nama', 'masakans.harga as harga']) as $data)
                <tr>
                    <td width="25%">
