                        ...
                        <div class="col-xs-12 col-sm-8 col-md-8 padt10 panel-medidu">
                            ...
                            <div>
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="active">
                                        <a href="{{url('/transaction')}}"><span class="fa fa-list"></span> Terbaru</a>           
                                    </li>
                                </ul>
                        ...
                        <div class="col-md-4 col-sm-8 padt10 col-xs-12">
                            ...
                            <div class="panel panel-medidu">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="box">
                                            <a href="{{ url('/transaction')}}/{{@$filter}}/add" class="btn btn-success btn-block"><i class="fa fa-plus-circle"></i> Tambah Data</a>
                                        </div>
                                    </div>
                                    @endif
...
$(document).ready(function(){
    ...
    var table = $('#transaction-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url('/transaction/datatables')}}",
        columns: [
