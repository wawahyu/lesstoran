...
<div class="container">
    <div class="row margint90">
        <ul class="breadcrumb">
            <li><a href="#">Home</a></li>
            <li><a href="{{url('owner/masakan/')}}">Laporan</a></li>
		...
		<div class="col-xs-12 col-sm-12 col-md-12 padt10 panel-medidu">                    
            ...
            <div>
				<ul class="nav nav-tabs">
					<li class="active">
						<a href="{{url('owner/laporan/filter/masakan')}}"><span class="fa fa-coffee"></span> Masakan</a>           
					</li>
					<li>
						<a href="{{url('owner/laporan/filter/pelanggan')}}"><span class="fa fa-user"></span> Pelanggan</a>            
					</li> 
					<li>
						<a href="{{url('owner/laporan/filter/pesanan')}}"><span class="fa fa-clipboard"></span> Pesanan</a>           
					</li>  
					<li>
						<a href="{{url('owner/laporan/filter/transaksi')}}"><span class="fa fa-money"></span> Transaksi</a>           
					</li>
				</ul>
...
$(document).ready(function(){
    ...
    var table = $('#masakan-table').DataTable({
        ...
        ajax: "{{ url('owner/masakan/datatables')}}",
        columns: [
