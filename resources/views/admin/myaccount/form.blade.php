        ...
        <div class="col-xs-12 col-sm-8 col-md-8 padt10 panel-medidu">
            ...
            <div>
                <div class="box"> 
					...
					<div class="box-body">
						<form id="form-user" action="{{url('admin/myaccount/edit')}}" class="form-horizontal" method="POST" enctype="multipart/form-data">
						{{ csrf_field() }}
        ...
        <div class="col-md-4 col-sm-8 padt10 col-xs-12">
            ...
            <div class="panel panel-medidu">
        		...
        		<div class="panel-footer">
					<div class="col-md-12">
						<div class="box">
							<a href="{{url('admin/myaccount/password')}}" class="btn btn-block btn-warning"><i class="fa fa-user"></i> Ubah Password</a>
						</div>
					</div>
