                            ...
                            <div>
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li @if (!@$filter) class="active" @endif>
                                        <a href="{{url('/order/myorder')}}"><span class="fa fa-list"></span> List</a>           
                                    </li>
                                    <li @if (@$filter == 'makanan') class="active" @endif>
                                        <a href="{{url('/order/myorder/filter/makanan')}}"><span class="glyphicon glyphicon-cutlery"></span> Makanan</a>            
                                    </li> 
                                    <li @if (@$filter == 'minuman') class="active" @endif>
                                        <a href="{{url('/order/myorder/filter/minuman')}}"><span class="glyphicon glyphicon-glass"></span> Minuman</a>           
                                    </li>            
                                </ul>
                        ...
                        <div class="col-md-4 col-sm-8 padt10 col-xs-12">
                            ...
                            <div class="panel panel-medidu">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="box">
                                            <a href="{{ url('/order')}}" class="btn btn-success btn-block"><i class="fa fa-plus-circle"></i> Tambah</a>
                                        </div>
                                    </div>
                ...
                <div class="modal-body">
                    {{csrf_field()}}
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="id_meja" style="width: 100%;">
                                <option value=""></option>
                            ...
                            <input type="text" name="atas_nama" required="required" class="form-control "></input>
                        </div>
...
<script id="details-layouts" type="text/x-handlebars-layouts">
    <form id="form-order" action="{{ url('/order') }}/@{{id_masakan}}/edit" class="form-horizontal" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    <table class="table">
        <tr>
            <td>Gambar</td>
...
$(document).ready(function(){
    ...
    var table = $('#order-table').DataTable({
        ...
        serverSide: true,
        @if(!@$filter)
        ajax: "{{ url('/order/myorder/datatables')}}",
        @else
        ajax: "{{ url('/order/myorder/datatables/filter') }}/{{$filter}}",
        @endif
        columns: [
