                        ...
                        <div class="col-xs-12 col-sm-8 col-md-8 padt10 panel-medidu">
                            ...
                            <div>
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="active">
                                        <a href="{{url('waiter/order')}}"><span class="fa fa-list"></span> Terbaru</a>           
                                    </li>
                        ...
                        <div class="col-md-4 col-sm-8 padt10 col-xs-12">
                            ...
                            <div class="panel panel-medidu">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="box">
                                            <a href="{{ url('waiter/order')}}/{{@$filter}}/add" class="btn btn-success btn-block"><i class="fa fa-plus-circle"></i> Tambah Data</a>
                                        </div>
                                    </div>
                                    @endif
...
<script id="details-layouts" type="text/x-handlebars-layouts">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <a href="#" order-id="@{{id}}" class="btn btn-block btn-info submit"><i class="glyphicon glyphicon-trash"></i> Submit</a>
            </td>
        </tr>
    </table>
</script>
...
$(document).ready(function(){
    ...
    var table = $('#order-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url('waiter/order/list/datatables')}}",
        columns: [
    ...
    $('#submit_form').on('submit', function(event){
        ...
        $.ajax({
                url:"{{url('waiter/order/list/update')}}",
                mehtod:"post",
                data:{id:id},
                data:form_data,
                dataType:'json',
