...
class TransactionListController extends Controller
{
    ...
    public function transaction_list_index(){
        ...
        return view('cashier.transaction_list.index', compact('title'));
    }
    ...
    public function transaction_list_update(Request $request, $id){
        ...
        if ($request->total_bayar < $total) {
            return redirect('cashier/transaction/list')->with('error','Uang Yang Anda Masukkan Kurang.');
        }
        else{
            ...
            if ($status) {
                return redirect('cashier/transaction/list')->with('success','Pesanan Berhasil Dibayar<br> Kembaliannya Rp.'.number_format($request->total_bayar-$total))->with('info', '<a href="'.url('cashier/transaction/list').'/'.$id.'/print" target="_blank" class="btn btn-info"><i class="fa fa-print"></i> Print</a>');
            }else
            {
    ...
    public function transaction_list_print($id){
        ...
        return view('cashier.transaction_list.print', compact('title', 'id', 'total_harga', 'total_bayar', 'pelanggan', 'created_at', 'id'));
    }
}
